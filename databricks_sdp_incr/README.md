...
The 'databricks_sdp_incr' project was generated by using the default template.

* `src/`: Python source code for this project.
  * `src/databricks_sdp_incr/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] databricks_sdp_incr_etl` to your workspace.
