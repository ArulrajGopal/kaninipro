...
The 'dbx_ldp_data_qual_quar' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/dbx_ldp_data_qual_quar/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] dbx_ldp_data_qual_quar_etl` to your workspace.
