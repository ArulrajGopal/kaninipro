...
The 'databricks_SDP_startup' project was generated by using the default template.

* `src/`: Python source code for this project.
  * `src/databricks_SDP_startup/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] databricks_SDP_startup_etl` to your workspace.
