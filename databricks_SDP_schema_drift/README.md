...
The 'databricks_dlt_schema_drift' project was generated by using the default template.

* `src/`: Python source code for this project.
  * `src/databricks_dlt_schema_drift/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] databricks_dlt_schema_drift_etl` to your workspace.
